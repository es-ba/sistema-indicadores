...
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE totales_calculados TO nnya_user;
GRANT SELECT ON TABLE diferencia_totales TO nnya_user;

GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE diferencia_totales TO nnya_user;
GRANT SELECT ON TABLE diferencia_totales TO nnya_user;
...
ALTER TABLE diferencia_totales
  OWNER TO nnya_owner;
GRANT ALL ON TABLE diferencia_totales TO nnya_owner;
GRANT SELECT ON TABLE diferencia_totales TO nnya_user;